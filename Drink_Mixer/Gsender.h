...
class Gsender
{
    ...
    private:
        ...
        const char* EMAILBASE64_LOGIN = "aGFuZHNmcmVlbWl4ZXI0NDVAZ21haWwuY29t";
        const char* EMAILBASE64_PASSWORD = "VGVhbUAjNDA=";
        const char* FROM = "handsfreemixer445@gmail.com";
